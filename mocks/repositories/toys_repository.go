...
//
//	mockgen -source=repositories.go -destination=../../mocks/repositories/tickets_repository.go -exclude_interfaces=RespondsRepository,TicketsRepository -package=mockrepositories
//
